 ...
 * @author Speed
 */
@ScriptManifest(authors = "Speed", keywords = {"Fletching"}, name = "AutoFletcher", version = 1.00, description = "Bow fletcher and stringer.")
public class AutoFletcher extends Script implements PaintListener,
