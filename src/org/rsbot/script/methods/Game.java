...
public class Game extends MethodProvider {
	...
	public boolean setPrayer(int pray, boolean activate) {
		return methods.interfaces.getComponent(271, 5).getComponents()[pray].getBackgroundColor() == -1 &&
		methods.interfaces.getComponent(271, 5).getComponents()[pray].doAction(activate ? "Activate" : "Deactivate");
	}
	...
	public boolean login() {
		return new org.rsbot.script.randoms.LoginBot().runRandom();
	}
