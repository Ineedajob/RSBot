...
public class ClanChat extends MethodProvider {
    ...
    public String[] getChannelUsers() {
        ...
        if (methods.game.getCurrentTab() == Game.TAB_CLAN_CHAT) {
            if (methods.interfaces.getComponent(INTERFACE_CLAN_CHAT, INTERFACE_CLAN_CHAT_USERS_LIST) != null) {
                for (RSComponent comp : methods.interfaces.getComponent(INTERFACE_CLAN_CHAT, INTERFACE_CLAN_CHAT_USERS_LIST).getComponents()) {
    ...
    public boolean isInChannel() {
        ...
        if (methods.game.getCurrentTab() == Game.TAB_CLAN_CHAT) {
            return methods.interfaces.getComponent(INTERFACE_CLAN_CHAT, INTERFACE_CLAN_CHAT_CHECK).containsText("If you");
