...
public class DrillDemon extends Random {
    ...
    public int loop() {
        ...
        if (interfaces.getComponent(148, 1).getText().contains("jumps")) {
            if (sign1 == 1) {
                if (calc.distanceTo(new RSTile(3167, 4820)) < 2) {
                    walking.walkTileMM(walking.randomizeTile(new RSTile(3160, 4820), 0, 0));
                    mat1.doAction("Use");
                } else {
                    mat1.doAction("Use");
                }
                ...
                if (calc.distanceTo(new RSTile(3159, 4820)) < 2) {
                    walking.walkTileMM(walking.randomizeTile(new RSTile(3166, 4820), 0, 0));
                    mat4.doAction("Use");
                } else {
                    mat4.doAction("Use");
                }
        ...
        } else if (interfaces.getComponent(148, 1).getText().contains("push ups")) {
            if (sign1 == 2) {
                if (calc.distanceTo(new RSTile(3167, 4820)) < 2) {
                    walking.walkTileMM(walking.randomizeTile(new RSTile(3160, 4820), 0, 0));
                    mat1.doAction("Use");
        ...
        } else if (interfaces.getComponent(148, 1).getText().contains("sit ups")) {
            if (sign1 == 3) {
                if (calc.distanceTo(new RSTile(3167, 4820)) < 2) {
                    walking.walkTileMM(walking.randomizeTile(new RSTile(3160, 4820), 0, 0));
                    mat1.doAction("Use");
